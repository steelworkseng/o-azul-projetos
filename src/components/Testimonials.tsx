...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      role: "Proprietário",
      content: "Economia de 35% comparado a outras propostas, sem perder qualidade. Recomendo para qualquer projeto de estrutura metálica.",
      rating: 5,
  ...
  const certifications = [
    { name: "CREA Ativo", description: "Registro profissional válido" },
    { name: "ISO 9001", description: "Gestão de qualidade certificada" },
    { name: "ABNT NBR", description: "Normas técnicas rigorosas" },
    { name: "200+ Projetos", description: "Experiência comprovada" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Mais de 200 projetos entregues com 100% de aprovação e satisfação total dos clientes
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="bg-card shadow-lg hover:shadow-primary transition-all duration-300 hover-scale">
